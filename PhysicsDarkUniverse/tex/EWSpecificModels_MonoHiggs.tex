...
\begin{figure}[hbpt!]
	...
	\subfloat[High mediator mass]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/models_cmp_MET_et_Log} \label{fig:met_cmp_high}
	}\\
	\subfloat[Low mediator mass]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/models_cmp_low_MET_et_Log} \label{fig:met_cmp_low}
	}
...
\begin{figure}[htpb!]
	...
	\subfloat[Leading $b-$jet transverse momentum]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/zpzp100/truth_leading_b_pt} %\label{fig:met_cmp_high}
	}\hfill
	\subfloat[Leading $b-$jet pseudorapidity]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/zpzp100/truth_leading_b_eta} %\label{fig:met_cmp_low}
	}\hfill
	\subfloat[Angular distance between the two leading $b-$jets]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/zpzp100/truth_bb_deltar} %\label{fig:met_cmp_low}
	}
...
\begin{figure}[htpb!]
	\centering
	\subfloat[Leading $b-$jet transverse momentum]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/zpzp1000/truth_leading_b_pt} %\label{fig:met_cmp_high}
	}\hfill
	\subfloat[Leading $b-$jet pseudorapidity]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/zpzp1000/truth_leading_b_eta} %\label{fig:met_cmp_low}
	}\hfill
	\subfloat[\text{Angular separation of the two leading $b$-jets}]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/zpzp1000/truth_bb_deltar} %\label{fig:met_cmp_low}
	}
...
\begin{figure}[hbpt!]
	\centering
	\subfloat[Leading $b-$jet transverse momentum]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/scalar100/truth_leading_b_pt} %\label{fig:met_cmp_high}
	}
	\hfill
	\subfloat[Leading $b-$jet pseudorapidity]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/scalar100/truth_leading_b_eta} %\label{fig:met_cmp_low}
	}\hfill
	\subfloat[Angular distance between the two leading $b-$jets]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/scalar100/truth_bb_deltar} %\label{fig:met_cmp_low}
	}
...
\begin{figure}[hbpt!]
	\centering
	\subfloat[Leading $b-$jet transverse momentum]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/scalar1000/truth_leading_b_pt} %\label{fig:met_cmp_high}
	}
	\hfill
	\subfloat[Leading $b-$jet pseudorapidity]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/scalar1000/truth_leading_b_eta} %\label{fig:met_cmp_low}
	}
	\hfill
	\subfloat[Angular distance between the two leading $b-$jets]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/scalar1000/truth_bb_deltar} %\label{fig:met_cmp_low}
	}
	\caption{Comparison of the kinematic distributions for the two leading jets from the Higgs decay in the scalar simplified model, 
...
\subfloat[\MET distribution]{
	\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/hxx_zp1000dm10gz01_met}
}
\hfill
\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
	\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/hxx_zp1000dm10gz01_dphi12}
}
...
\begin{figure}[htpb!]
	\centering
	\subfloat[\MET distribution]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/tanb1zp1000gz08_met}
	}
	\hfill
	\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/tanb1zp1000gz08_dphi12}
	}
...
The kinematic distributions with varying $M_{\Zprime}$ for fixed $M_{A^0}$ are shown in Fig.~\ref{fig:DMH_mzp}, while the dependency on $M_{A^0}$ is shown in Fig.~\ref{fig:DMH_ma0}. 
 ...
 \begin{figure}[htpb!]
 	\centering
 	\subfloat[\MET distribution]{
 		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mA300mZp_met}
 	}
 	\hfill
 	\subfloat[Leading $b-$jet $p_T$  distribution]{
 		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mA300mZp_p0}
 	}
 	\hfill
 	\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
 		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mA300mZp_dphi12}
 	}
 ...
 \end{figure}
   ...
   \begin{figure}[htpb!]
   	\centering
   	\subfloat[\MET distribution]{
   		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mZp1000mA_met}
   	}\hfill
   	\subfloat[Leading $b-$jet $p_T$ distribution]{
   		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mZp1000mA_p0}
   	}
   	\hfill
   	\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
   		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mZp1000mA_dphi12}
   	}
...
\begin{figure}[htpb!]
  	\centering
  	\subfloat[\MET distribution]{
  		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/Zp_tanb1gz08mA300mZp1000_met}
  	}\hfill
  	\subfloat[Leading $b-$jet $p_T$ distribution]{
  		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/Zp_tanb1gz08mA300mZp1000_dphimetj0}
  	}
  	\hfill
  	\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
  		\includegraphics[width=0.65\linewidth]{figures/EW/monoH/2hdm/Zp_tanb1gz08mA300mZp1000_dphi12}
  	}
