...
phenomenology further studied in Refs.~\cite{LopezHonorez:2006gr,ScalarMultiplet,IDMnewviable,IDMgammalines,Dolle:2009fn,ATL-PHYS-PUB-2014-007,IDMnu1,IDMnu2,IDMpos,IDMVIB,IDMposthiggs,Belyaev:2015tap}. It is an extension of the SM with a second scalar 
...
Based on the various LHC search channels, DM phenomenology issues and theoretical considerations, numerous works have proposed benchmark scenarios for the IDM, see e.g. \cite{IDMmultileptons,IDMposthiggs} while a FeynRules implementation (including MadGraph, CalcHEP and micrOMEGAs model files) was provided in \cite{IDMmultileptons}. An updated analysis of the parameter space has recently been performed in Ref.~\cite{Belyaev:2015tap}. 
