...
\usepackage[hyperref=true,url=false,backend=bibtex,style=alphabetic,backref=false,firstinits=true,doi=true,eprint=true,date=year]{biblatex}
% biblatex commands follow from example by Ian Brock (ian.brock@cern.ch)
