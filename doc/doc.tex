...
\title{Dark Matter Benchmark Models for Early LHC Run-2 Searches:
  Report~of~the~Spring~2015 ATLAS/CMS~Dark~Matter~Forum}
...
\chapter{\texorpdfstring{Recommended models for all \MET+X analyses}{Recommended models for all MET+X analyses}}
