...
are considered, together with contact interaction operators wherever simplified models are not available
and specific simplified models leading to mono-boson signatures. The technical implementation and further models that can be studied
