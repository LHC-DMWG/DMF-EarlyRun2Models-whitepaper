...
boson ($W/Z/gamma/H$). Simplified models from chapter~\ref{subsec:MonojetLikeModels}
are considered, together with contact interaction operators and specific simplified models leading
to mono-boson signatures. The technical implementation and further models that can be studied
