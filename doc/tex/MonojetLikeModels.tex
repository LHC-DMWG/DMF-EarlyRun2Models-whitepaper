...
\centering
\subfloat[]{
\includegraphics[width=0.73\textwidth]{figures/monojet/mxx.eps}% width = 0.73 => regular textwidth of figure environment. figure* used to avoid overlapping captions.
