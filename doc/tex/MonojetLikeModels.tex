...
It should be noted again that this procedure is only useful when the narrow width approximation applies. Care must be taken to ensure that is the case. For example, in the \modelV and \modelA case, one quickly breaks this approxmation even for small $n$.
