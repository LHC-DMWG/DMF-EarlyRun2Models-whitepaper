...
\centering
\subfloat[]{
\includegraphics[width=0.75\textwidth]{figures/monojet/mxx.eps}% width = 0.73 => regular textwidth of figure environment. figure* used to avoid overlapping captions.
\label{fig:monojet_mchichi_a}}
\hfill
\subfloat[]{
\includegraphics[width=0.75\textwidth]{figures/EFT/TruthShat3_compEFTvsZprime_DM150_narrow_new}
