...
In terms of comparisons to the EFT samples, the simplified models with larger mediator widths (e.g. for couplings of 1) are the ones resembling the kinematics of contact interactions, since the production there is always off-shell, i.e. no peak in the $m_{\bar{\chiDM}\chiDM}$ distribution is present.
