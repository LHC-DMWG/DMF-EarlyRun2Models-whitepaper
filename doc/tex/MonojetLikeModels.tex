...
\centering
\subfloat[]{
\includegraphics[width=0.7\textwidth]{figures/monojet/mxx.eps}% width = 0.73 => regular textwidth of figure environment. figure* used to avoid overlapping captions. You wish, it still overlaps. Moved figures to new page, had to change the figure env in the other one and move it upwards.
\label{fig:monojet_mchichi_a}}
\hfill
\subfloat[]{
\includegraphics[width=0.7\textwidth]{figures/EFT/TruthShat3_compEFTvsZprime_DM150_narrow_new.eps}
