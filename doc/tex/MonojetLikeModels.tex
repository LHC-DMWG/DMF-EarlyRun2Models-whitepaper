...
%TODO comment on the values in the plot.
...
%TODO show the plot from 0 to 2pi
...
%TODO say that the g-g plane can be used to recast the results on gammamin to different mediator widths.
