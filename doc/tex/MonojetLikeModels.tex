...
There are several matrix element implementations of the s-channel vector mediated DM production: POWHEG, MADGRAPH and also MCFM.
...
Since NLO calculations are available for the process in POWHEG, we recommend to proceed with POWHEG as the generator of choice.{\bf [Comment on MadGraph uses: k-factors, allowed initial state partons, proper combination of LO ME with LO PDF?]}
