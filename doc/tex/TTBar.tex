...
mediators leads to quark mass dependent Yukawa couplings and therefore dominant couplings to top quarks.
...
of benchmarks is to focus on the phase space where we expect the searches to be sensitive during the 2015 LHC run. 
...
we detail the specific studies done for this model. 
