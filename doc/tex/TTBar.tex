As described in Section~\ref{sec:monojet_scalar}, one of the most simple UV complete extension of the effective field theory approach is the addition of a scalar mediator between DM and SM.
...
As discussed in Sec.~\ref{sec:scalar}, the MFV assumption for spin-$0$ mediators leads to quark mass dependent Yukawa couplings, and therefore dominant couplings to top quarks. This motivates dedicated DM+$t\bar{t}$ searches. 
...
The points for the parameter scan chosen for this model are listed in Table~\ref{tab:mDMmMedScan}, chosen
