...
Dedicated implementations of these models for the works of this Forum are available at LO+PS accuracy,
...
The studies in this Section have been produced using a leading order model within \madgraph 2.2.2, 
