...
The kinematic distributions are most dependent on the masses $m_{\chi}$ and $m_{\phi,a}$. Figure~\ref{fig:scanPhi} and~\ref{fig:scanPhiPseudo} show typical dependencies for scalar and pseudoscalar couplings respectively.
