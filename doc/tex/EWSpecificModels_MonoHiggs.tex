...
\begin{figure*}[hbpt!]
	...
	\subfloat[High mediator mass]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/models_cmp_MET_et_Log} \label{fig:met_cmp_high}
	}\\
	\subfloat[Low mediator mass]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/models_cmp_low_MET_et_Log} \label{fig:met_cmp_low}
	}
...
\begin{figure}[hbpt!]
	...
	\subfloat[Leading $b-$jet transverse momentum]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/zpzp100/truth_leading_b_pt} %\label{fig:met_cmp_high}
	}
	\hfill
	\subfloat[Leading $b-$jet pseudorapidity]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/zpzp100/truth_leading_b_eta} %\label{fig:met_cmp_low}
	}
%	\hfill
%	\subfloat[Leading $b-$jet transverse momentum]{
...
%	}
	...
	\subfloat[Angular distance between the two leading $b-$jets]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/zpzp100/truth_bb_deltar} %\label{fig:met_cmp_low}
	}
...
\begin{figure}[hbpt!]
	\centering
	\subfloat[Leading $b-$jet transverse momentum]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/zpzp1000/truth_leading_b_pt} %\label{fig:met_cmp_high}
	}
	\hfill
	\subfloat[Leading $b-$jet pseudorapidity]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/zpzp1000/truth_leading_b_eta} %\label{fig:met_cmp_low}
	}
%	\hfill
%	\subfloat[Leading $b-$jet transverse momentum]{
...
%	}
	...
	\subfloat[\text{Angular separation of the two leading $b$-jets}]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/zpzp1000/truth_bb_deltar} %\label{fig:met_cmp_low}
	}
...
through the Higgs field. The most general scalar potential is detailed in Ref.~\ref{O'Connell:2006wi}, 
including terms that break \Ztwo. This report does not cover the case in which \Ztwo holds and
therefore the new scalar can be the DM candidate, but follows Ref.~\ref{Carpenter:2013xra}
...
\begin{figure}[hbpt!]
	\centering
	\subfloat[Leading $b-$jet transverse momentum]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/scalar100/truth_leading_b_pt} %\label{fig:met_cmp_high}
	}
	\hfill
	\subfloat[Leading $b-$jet pseudorapidity]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/scalar100/truth_leading_b_eta} %\label{fig:met_cmp_low}
	}
%	\hfill
%	\subfloat[Leading $b-$jet transverse momentum]{
...
%	}
	\hfill
	\subfloat[Angular distance between the two leading $b-$jets]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/scalar100/truth_bb_deltar} %\label{fig:met_cmp_low}
	}
...
\begin{figure}[hbpt!]
	\centering
	\subfloat[Leading $b-$jet transverse momentum]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/scalar1000/truth_leading_b_pt} %\label{fig:met_cmp_high}
	}
	\hfill
	\subfloat[Leading $b-$jet pseudorapidity]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/scalar1000/truth_leading_b_eta} %\label{fig:met_cmp_low}
	}
%	\hfill
%	\subfloat[Leading $b-$jet transverse momentum]{
...
%	}
	\hfill
	\subfloat[Angular distance between the two leading $b-$jets]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/scalar1000/truth_bb_deltar} %\label{fig:met_cmp_low}
	}
	\caption{Comparison of the kinematic distributions for the two leading jets from the Higgs decay in the scalar simplified model, 
...
\Todo{Steve Mrenna (?): Total width still comes from qqZ' and chichiZ' couplings? CD: what do you mean?}
...
\subfloat[\MET distribution]{
	\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/hxx_zp1000dm10gz01_met}
}
\hfill
\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
	\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/hxx_zp1000dm10gz01_dphi12}
}
...
\begin{figure}[h!]
	\centering
	\subfloat[\MET distribution]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/tanb1zp1000gz08_met}
	}
	\hfill
	\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/tanb1zp1000gz08_dphi12}
	}
...
The kinematic distributions with varying $M_{\Zprime}$ for fixed $M_{A^0}$ are shown in Fig.~\ref{fig:DMH_mzp}, while the dependency on $M_{A^0}$ is shown in Fig.~\ref{fig:DMH_ma0}. 
 ...
 \begin{figure}[h!]
 	\centering
 	\subfloat[\MET distribution]{
 		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mA300mZp_met}
 	}
 	\hfill
 	\subfloat[Leading $b-$jet $p_T$  distribution]{
 		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mA300mZp_p0}
 	}
 	\hfill
 	\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
 		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mA300mZp_dphi12}
 	}
 	\hfill
 	\subfloat[Dijet invariant mass]{
 		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mA300mZp_mbb}
 	}
 ...
 \end{figure}
   ...
   \begin{figure}[h!]
   	\centering
   	\subfloat[\MET distribution]{
   		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mZp1000mA_met}
   	}
   	\hfill
   	\subfloat[Leading $b-$jet $p_T$ distribution]{
   		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mZp1000mA_p0}
   	}
   	\hfill
   	\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
   		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mZp1000mA_dphi12}
   	}
   	\hfill
   	\subfloat[Dijet invariant mass]{
   		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/ZpA0h_tanb1gz08mZp1000mA_mbb}
   	}
...
\Todo{What about visible decays of Z?   And isn't monojet still more sensitive?}
 
\begin{figure}[h!]
  	\centering
  	\subfloat[\MET distribution]{
  		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/Zp_tanb1gz08mA300mZp1000_met}
  	}
  	\hfill
  	\subfloat[Leading $b-$jet $p_T$ distribution]{
  		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/Zp_tanb1gz08mA300mZp1000_dphimetj0}
  	}
  	\hfill
  	\subfloat[$\Delta\phi$ distance between the two $b-$ jets]{
  		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/Zp_tanb1gz08mA300mZp1000_dphi12}
  	}
  	\hfill
  	\subfloat[Dijet invariant mass]{
  		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/2hdm/Zp_tanb1gz08mA300mZp1000_mjj}
  	}
...
\newthought{The implementation of these models is discussed in Appendix~\ref{sub:monoHiggs}.}
