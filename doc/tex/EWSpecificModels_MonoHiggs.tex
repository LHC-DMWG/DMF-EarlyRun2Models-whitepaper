...
\begin{figure}[!h!tpd]
	...
	\subfloat[\label{subfig:modelMonoHZprimeqq}]{
		...
		\fmf{dashes,label={\Large $Z^\prime$}}{v1,v2}
		\fmf{dashes,label={\Large $Z^\prime$},label.angle=-100,label.distance=5}{v2,v3}
		\fmf{dashes}{v2,o3}
		\fmflabel{\Large $h$}{o3}
...
\footnote{\begin{align*}\lambda(c_1,c_2,c_3) \equiv\;c_1^2 + c_2^2 + c_3^2\\ 
