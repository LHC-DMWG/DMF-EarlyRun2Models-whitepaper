...
is the standard \modelDMV model in the large $M_{Z^\prime}$ limit.   It can lead
to a monojet signature.
...
\Todo{Total width still comes from qqZ' and chichiZ' couplings?}
...
\subsubsection{Parameter scan}
 ...
 \end{itemize}
 \Todo{What about Z' coupling to q and DM?}
