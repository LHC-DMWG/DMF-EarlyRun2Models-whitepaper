%\svnidlong
%{$HeadURL: svn+ssh://doglioni@svn.cern.ch/reps/LHCDMF/trunk/doc/tex/EFTValidity.tex $}
%{$LastChangedDate: 2015-07-01 00:23:48 +0200 (Wed, 01 Jul 2015) $}
%{$LastChangedRevision: 436 $}
%{$LastChangedBy: lowette $}
%\svnid{$Id: $}
...
%% \begin{figure}
%% \centering
%% \includegraphics[width=0.9\textwidth]{figures/monojet/lambda_14TeV_SR1}
