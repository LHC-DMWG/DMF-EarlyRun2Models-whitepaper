...
Ideally, experimental results should be cast into bounds of allowed signal events in the kinematic regions considered for 
...
mediator mass and scale of the interaction to determine the validity of the EFT approximation.
...
\Todo{Too strong of a statement? CD: more like - I don't think this parses. Rewritten.}
...
should be applied for various hypotheses on the validity of the EFT in question, 
