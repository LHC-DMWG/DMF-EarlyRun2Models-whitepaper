...
%It is important to consider what information phenomenologists need in order to reinterpret the LHC searches. The following is a non-exhaustive list of recommendations in order to ensure reinterpretation is possible, efficient, and fast. 
...
Efficiency maps and relevant kinematic distributions as reported in the analysis, with clearly specified units.
