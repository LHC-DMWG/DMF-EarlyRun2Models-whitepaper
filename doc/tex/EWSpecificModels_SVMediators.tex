...
\begin{figure}[h!]
	...
	\subfloat[Missing transverse momentum distribution for the hadronic W+MET final state.\label{fig:DMV_EW_Whad_MET_SVMed}]{%
		\includegraphics[width=0.47\textwidth]{figures/EW/monoWhad_Destructive/metPt}
	}    
...
The parameter scan is still under discussion~\Todo{The parameter scan, 
...
Parameter cards can be found on the Forum SVN repository \textbf{[TODO~\cite{}]}.
