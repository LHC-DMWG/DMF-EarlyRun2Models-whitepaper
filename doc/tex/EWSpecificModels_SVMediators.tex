...
for different DM mass choices, with \mMed=1 TeV.\label{fig:DMV_EW_gamma_pT_SVMed}]{%
...
Results can then be recast at the reinterpretation stage, by rescaling the cross-sections.  
