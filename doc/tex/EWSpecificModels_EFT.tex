...
and ~\cite{ForumSVN_EWEFTD7} for dimension 7 and 8.

When generating the Higgs+MET processes using the dimension 8 operator, it is necessary to set $QED=3$ in the Madgraph command line:

\begin{verbatim}
generatepp>hxx QED=3,h>bb
\end{verbatim}