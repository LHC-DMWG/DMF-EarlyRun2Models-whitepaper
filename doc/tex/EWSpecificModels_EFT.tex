...
into two $b-$quarks is shown in Fig.~\ref{fig:Hbb_Dim5}, for points similar to those of the grid scan proposed. 
 ...
 \begin{figure}[hbpt!]
 	...
 	\subfloat[Leading $b-$jet pseudorapidity]{
 		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/xxhhg5/truth_leading_b_eta} %\label{fig:met_cmp_low}
 	}
% 	\hfill
% 	\subfloat[Leading $b-$jet transverse momentum]{
...
%TODO: put in appendix
 	\subfloat[Angular distance between the two leading $b-$jets]{
 		\includegraphics[width=0.95\linewidth]{figures/EW/monoH/xxhhg5/truth_bb_deltar} %\label{fig:met_cmp_low}
 	}
 	\hfill
