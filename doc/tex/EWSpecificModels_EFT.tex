...
%		\centering
%		\includegraphics[width = \linewidth]{xgxFhDh/truth_leading_b_pt}
%	\end{minipage}
%	\begin{minipage}{0.5\textwidth}
%		\centering
%		\includegraphics[width = \linewidth]{xgxFhDh/truth_leading_b_eta}
%	\end{minipage}
%\end{figure}
%
%\begin{figure}[!htbp]
%	\begin{minipage}{0.5\textwidth}
%		\centering
%		\includegraphics[width = \linewidth]{xgxFhDh/truth_subleading_b_pt}
%	\end{minipage}
%	\begin{minipage}{0.5\textwidth}
%		\centering
%		\includegraphics[width = \linewidth]{xgxFhDh/truth_subleading_b_eta}
%	\end{minipage}
%\end{figure}
%
%\begin{figure}[!htbp]
%	\begin{minipage}{0.5\textwidth}
%		\centering
%		\includegraphics[width = \linewidth]{xgxFhDh/truth_bb_deltar}
%	\end{minipage}
%\end{figure}
%
%\FloatBarrier
