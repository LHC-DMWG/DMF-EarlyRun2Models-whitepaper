...
$\gDM = {(246~\gev)}/{\lambda}$\Todo{Clarify the reason why this happens 
	in Madgraph through explicit Lagrangian terms?}.

The initial value of the new physics scale $\lambda$ chosen 
for the sample generation is 3~\tev; this does not affect the signal kinematics, 
...
\Todo{Include study of rescaling for dimension-8 operators by N. Whallon in dimension-8 section.}
%From Andy
