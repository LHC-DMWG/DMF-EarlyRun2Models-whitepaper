...
over considering these operators as realistic benchmarks. We also recommend not to 
optimize searches based on those benchmark models. 
...
We devote the end of this Section to provide a recommendation on 
how to present the results from this model, including an assessment of their  
...
\newthought{Model implementation discussed in Appendix~\ref{}}
