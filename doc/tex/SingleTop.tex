%\svnidlong
%{$HeadURL: svn+ssh://doglioni@svn.cern.ch/reps/LHCDMF/trunk/doc/tex/SingleTop.tex $}
%{$LastChangedDate: 2015-06-30 22:05:35 +0200 (Tue, 30 Jun 2015) $}
%{$LastChangedRevision: 434 $}
%{$LastChangedBy: doglioni $}
%\svnid{$Id: SingleTop.tex 434 2015-06-30 20:05:35Z doglioni $}
...
\begin{figure*}[!htb]
	\centering
	\includegraphics[width=0.3\textwidth]{figures/singletop/Width/c_PTvmet200GeV_IsLog}
	\includegraphics[width=0.3\textwidth]{figures/singletop/Width/c_PTvmet600GeV_IsLog}
	\includegraphics[width=0.3\textwidth]{figures/singletop/Width/c_PTvmet1000GeV_IsLog}
	\caption{
