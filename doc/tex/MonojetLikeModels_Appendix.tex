...
%However, the complete story of generating heavy narrow mediators is a cautionary tale about understanding the details of the generator tools.
...
\Todo{CD: I would like to uncomment the details on the implementation of CKKW-L matching as this is what was done in ATLAS so far. }
...
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/HistoJet1to2_30.pdf}
%% 	}
%% 	\hfill
%% 	\subfloat[$2\rightarrow3$ jets]{%
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/HistoJet2to3_30.pdf}
%% 	}
%% 	\hfill
%% 	\subfloat[$3\rightarrow4$ jets]{%
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/HistoJet3to4_30.pdf}
%% 	}
%% 	\hfill
%% 	\subfloat[$4\rightarrow5$ jets]{%
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/HistoJet4to5_30.pdf}
%% 	}
...
%% 	\centering  
%% 	\subfloat[$1\rightarrow2$ jets]{%
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/HistoJet1to2_80.pdf}
%% 	}
%% 	\hfill
%% 	\subfloat[$2\rightarrow3$ jets]{%
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/HistoJet2to3_80.pdf}
%% 	}
%% 	\hfill
%% 	\subfloat[$3\rightarrow4$ jets]{%
%%     \includegraphics[width=0.95\linewidth]{figures/monojet_appendix/HistoJet3to4_80.pdf}
%% 	}
%% 	\hfill
%% 	\subfloat[$4\rightarrow5$ jets]{%
%%     \includegraphics[width=0.95\linewidth]{figures/monojet_appendix/HistoJet4to5_80.pdf}
%% 	}
...
%% 	\centering  
%% 	\subfloat[$1\rightarrow2$ jets]{%
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/compare_plot_1.pdf}
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/window_plot_1.pdf}
%% 	}
%% 	\hfill
%% 	\subfloat[$2\rightarrow3$ jets]{%
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/compare_plot_2.pdf}
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/window_plot_2.pdf}
%% 	}
%% 	\hfill
%% 	\subfloat[$3\rightarrow4$ jets]{%
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/compare_plot_3.pdf}
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/window_plot_3.pdf}
%% 	}
%% 	\hfill
%% 	\subfloat[$4\rightarrow5$ jets]{%
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/compare_plot_4.pdf}
%% 		\includegraphics[width=0.95\linewidth]{figures/monojet_appendix/window_plot_4.pdf}
%% 	}
...
No parton matching is required in this case. 

We simulate the bFDM model at LO+PS using the {\tt MG5\_aMC} v2.2.3 generator and Pythia8 for the parton shower. 
Parton matching is needed in the case of the $b\bar{b}$+\MET{} final state, but it has not been studied within the Forum. 
