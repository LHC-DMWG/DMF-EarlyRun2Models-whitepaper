...
the lower analysis \MET cut, for the event selection used in the
...
Here the 0-, 1-, 2- and 3-parton emissions are generated separately and requested in matching step with \texttt{Merging:nJetMax=3} and scale at 80~\gev in \pythiaEight for 0+1+2+3 parton emission case, while \texttt{Merging:nJetMax=2} requested for 0+1+2 case and \texttt{Merging:nJetMax=1} requested for 0+1 case. The MET distribution is plotted in Fig.\ref{fig:RatioKine_D5}, while the jet multiplicity with $p_{T}>$30~\gev and $|\eta|<$2.8 requirement is shown in Fig.\ref{fig:RatioKine_D5_2}.
