...
interfaced to \pythia 8. Further implementation details can be found in Section~\label{sec:TTBar_implementation}.
...
\begin{figure*}[h!]
  ...
  \caption{\MET (left) and jet multiplicity (right) for $\mDM=35$~GeV and $\MPhi=500$~GeV for couplings corresponding to relic density weights, with varying $g=1,2$} \label{fig:g_comp}
\end{figure*}
