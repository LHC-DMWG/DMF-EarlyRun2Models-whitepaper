...
As for the \schannel models, we assume Minimal Flavour Violation (MFV), setting the mediator masses for each flavour equal; the same logic also applies to the couplings $g$. Coupling to the third generation breaks the MFV assumption and is thus forbidden. The free parameters are then
...
The parameter scan for the $t-$ channel model in the case of signatures including EW bosons
follows that of the monojet case. 
