...
As for the \schannel models, we assume Minimal Flavor Violation (MFV), setting the mediator masses for each flavor equal; the same logic also applies to the couplings $g$. Coupling to the third generation breaks the MFV assumption and is thus forbidden. The free parameters are then
