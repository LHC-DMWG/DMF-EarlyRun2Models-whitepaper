...
by production cross-section~\Todo{Ask A. Vichi again for justification text}. The studies in this Section
...
in the time-frame of the conclusions of this Forum. Further implementation details can be found in Section~\label{sec:tchannel_implementation}
...
They are outlined in Table~\ref{tab:tchannel_parameter_scan}.\Todo{Is 9 a reasonable, perturbative coupling?} 
...
while only the left-handed mediator in~\cite{Bell:2012rg} allows for W and Z radiation.~\Todo{Check why this happens: question asked to A. Vichi.}
