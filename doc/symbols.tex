...
\newcommand{\madanalysis}{{\sc MadAnalysis}\xspace}
\newcommand{\powheg}{{\sc POWHEG}\xspace}
\newcommand{\mcfm}{{\sc MCFM}\xspace}
\newcommand{\fewz}{{\sc Fewz}\xspace}
\newcommand{\hathor}{{\sc Hathor}\xspace}
\newcommand{\pythia}{{\sc Pythia}\xspace}
\newcommand{\pythiaEight}{{\sc Pythia~8}\xspace}
\newcommand{\tauola}{{\sc Tauola}\xspace}
