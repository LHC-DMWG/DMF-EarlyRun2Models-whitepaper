...
//=========  (Thu May 28 16:36:49 2015) by ROOT version5.34/25
   ...
   graph->SetPoint(0,50,2539);
   graph->SetPoint(1,150,2548);
   graph->SetPoint(2,500,3256);
   graph->SetPoint(3,1000,3922);
   ...
   graph->SetMarkerStyle(20);
   graph->SetMarkerSize(1.2);
   graph->SetPoint(0,50,1836);
   graph->SetPoint(1,150,1916);
   graph->SetPoint(2,500,2492);
   graph->SetPoint(3,1000,3252);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,0,1095);
   Graph_Graph2->SetMinimum(1694.4);
   Graph_Graph2->SetMaximum(3393.6);
   ...
   graph->SetMarkerStyle(20);
   graph->SetMarkerSize(1.2);
   graph->SetPoint(0,50,1232);
   graph->SetPoint(1,150,1222);
   graph->SetPoint(2,500,1839);
   graph->SetPoint(3,1000,2729);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,0,1095);
   Graph_Graph3->SetMinimum(1071.3);
   Graph_Graph3->SetMaximum(2879.7);
   ...
   graph->SetMarkerStyle(20);
   graph->SetMarkerSize(1.2);
   graph->SetPoint(0,50,653);
   graph->SetPoint(1,150,763);
   graph->SetPoint(2,500,1337);
   graph->SetPoint(3,1000,2300);
   
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Graph",100,0,1095);
   Graph_Graph4->SetMinimum(488.3);
   Graph_Graph4->SetMaximum(2464.7);
