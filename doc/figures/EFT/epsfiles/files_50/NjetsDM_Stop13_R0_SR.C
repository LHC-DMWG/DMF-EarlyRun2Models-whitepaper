...
//=========  (Thu May 28 17:05:47 2015) by ROOT version5.34/25
   TCanvas *canvas3 = new TCanvas("canvas3", "canvas3",10,32,700,500);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   canvas3->SetHighLightColor(2);
   canvas3->Range(-1.945783,-0.1271865,10.10241,0.6677289);
   ...
   histo_n_jets50__7->SetBinContent(2,0.5980792);
   histo_n_jets50__7->SetBinContent(3,0.2581033);
   histo_n_jets50__7->SetBinContent(4,0.1042017);
   histo_n_jets50__7->SetBinContent(5,0.02761105);
   histo_n_jets50__7->SetBinContent(6,0.008643458);
   histo_n_jets50__7->SetBinContent(7,0.002641056);
   histo_n_jets50__7->SetBinContent(8,0.0004801921);
   histo_n_jets50__7->SetBinContent(10,0.000240096);
   histo_n_jets50__7->SetBinError(2,0.01198317);
   histo_n_jets50__7->SetBinError(3,0.007872075);
   histo_n_jets50__7->SetBinError(4,0.005001841);
   histo_n_jets50__7->SetBinError(5,0.002574743);
   histo_n_jets50__7->SetBinError(6,0.001440576);
   histo_n_jets50__7->SetBinError(7,0.0007963085);
   histo_n_jets50__7->SetBinError(8,0.0003395471);
   histo_n_jets50__7->SetBinError(10,0.000240096);
   histo_n_jets50__7->SetEntries(4165);
   ...
   histo_n_jets400__8->SetBinContent(2,0.5852062);
   histo_n_jets400__8->SetBinContent(3,0.2646738);
   histo_n_jets400__8->SetBinContent(4,0.1036439);
   histo_n_jets400__8->SetBinContent(5,0.03360244);
   histo_n_jets400__8->SetBinContent(6,0.008946105);
   histo_n_jets400__8->SetBinContent(7,0.003272965);
   histo_n_jets400__8->SetBinContent(8,0.0006545931);
   histo_n_jets400__8->SetBinError(2,0.01130003);
   histo_n_jets400__8->SetBinError(3,0.007599422);
   histo_n_jets400__8->SetBinError(4,0.004755508);
   histo_n_jets400__8->SetBinError(5,0.002707762);
   histo_n_jets400__8->SetBinError(6,0.001397147);
   histo_n_jets400__8->SetBinError(7,0.000845076);
   histo_n_jets400__8->SetBinError(8,0.0003779295);
   histo_n_jets400__8->SetEntries(4583);
   ...
   leg->SetFillColor(0);
   leg->SetFillStyle(0);
   TLegendEntry *entry=leg->AddEntry("histo_n_jets50","EFT D5 m_{DM} = 50 GeV","l");
   ...
   entry=leg->AddEntry("histo_n_jets400","Z' m_{DM} = 50 GeV","l");
